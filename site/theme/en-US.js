module.exports = {
  ...
  messages: {
    ...
    'app.header.menu.pro': 'ProComponents',
    'app.header.menu.more': 'More',
    'app.header.menu.mobile': 'Mobile',
    'app.header.menu.pro.v4': 'Infra Design Pro',
    'app.header.menu.pro.components': 'Infra Design Pro Components',
    'app.header.menu.charts': 'Infra Design Charts',
    ...
    'app.home.design-values-description':
      'This is Infra Design\'s internal standard for evaluating design quality. Based on the assumption that "everyone is pursuing happiness at work", we have added the two values of "Meaningfulness" and "Growth" on the basis of "Certainty" and "Naturalness" to guide each designer towards better judgment and decision-making.',
    ...
    'app.home.product-mobile-slogan': 'Mobile UI components with Infra Design',
    ...
    'app.footer.awesome': 'Awesome Infra Design',
    'app.footer.course': 'Infra Design Practical Tutorial',
    ...
    'app.footer.zhihu': 'Infra Design Blog',
    ...
    'app.docs.components.icon.shopee': 'Shopee infra Icons',
    ...
    'app.docs.components.icon.category.status': 'Status Icons',
    'app.docs.components.icon.category.expain': 'Explain Icons',
    'app.docs.components.icon.category.operation': 'Operation Icons',
