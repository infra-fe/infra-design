module.exports = {
  ...
  messages: {
    ...
    'app.header.menu.article.trigger': '目录',
    ...
    'app.home.design-values-description':
      '这是 Infra Design 评价设计好坏的内在标准。基于「每个人都追求快乐工作」这一假定，我们在「确定性」和「自然」的基础上，新增「意义感」和「生长性」两个价值观，指引每个设计者做更好地判断和决策。',
    ...
    'app.footer.zhihu': 'Infra Design 专栏',
    ...
    'app.docs.components.icon.shopee': 'Shopee Infra 图标',
    ...
    'app.docs.components.icon.category.status': '状态图标',
    'app.docs.components.icon.category.explain': '说明型图标',
    'app.docs.components.icon.category.operation': '操作型图标',
