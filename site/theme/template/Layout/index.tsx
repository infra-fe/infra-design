...
import type { TwoToneColor } from 'infra-design-icons';
...
if (typeof window !== 'undefined') {
  ...
  // eslint-disable-next-line global-require
  (window as any).infrad = require('infrad');
  // eslint-disable-next-line global-require
  (window as any)['@ant-design/icons'] = require('@ant-design/icons');
  // eslint-disable-next-line global-require
  (window as any)['infra-design-icons'] = require('infra-design-icons');
  ...
  render() {
    ...
    const title =
      appLocale.locale === 'zh-CN'
        ? 'Infra Design - 一套企业级 UI 设计语言和 React 组件库, 基于AntD'
        : "Infra Design - The world's second most popular React UI framework, based on AntD";
    const description =
      appLocale.locale === 'zh-CN'
        ? '基于 Infra Design 设计体系的 React UI 组件库，用于研发企业级中后台产品。'
