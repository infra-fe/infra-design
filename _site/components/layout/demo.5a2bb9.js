...
`}},3881:function(v,N,p){v.exports={content:{"zh-CN":[["p","\u4FEE\u6539\u5185\u5BB9\u524D\uFF0C\u8BF7\u5C1D\u8BD5\u6B64 Demo \u67E5\u770B\u6837\u5F0F\u662F\u5426\u6296\u52A8\u3002"],["pre",{lang:"tsx",highlighted:`import {
...
<span class="token selector"><span class="token class">.site-layout</span> <span class="token class">.site-layout-background</span> </span><span class="token punctuation">{</span>
  <span class="token property">background</span><span class="token punctuation">:</span> <span class="token hexcode">#fff</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>`,src:"/demo-0.7983026207469934.html"}},3884:function(v,N,p){v.exports={content:{"zh-CN":[["p","\u4E00\u822C\u7528\u4E8E\u56FA\u5B9A\u9876\u90E8\u5BFC\u822A\uFF0C\u65B9\u4FBF\u9875\u9762\u5207\u6362\u3002"]],"en-US":[["p","Fixed Header is generally used to fix the top navigation to facilitate page switching."]]},meta:{order:7,iframe:360,title:{"zh-CN":"\u56FA\u5B9A\u5934\u90E8","en-US":"Fixed Header"},filename:"components/layout/demo/fixed.md",id:"components-layout-demo-fixed"},toc:["ul",["li",["a",{className:"bisheng-toc-h2",href:"#zh-CN",title:"zh-CN"},"zh-CN"]],["li",["a",{className:"bisheng-toc-h2",href:"#en-US",title:"en-US"},"en-US"]]],highlightedCode:["pre",{lang:"tsx",highlighted:`import { Breadcrumb<span class="token punctuation">,</span> Layout<span class="token punctuation">,</span> Menu } from <span class="token string">'infrad'</span><span class="token comment" spellcheck="true">;</span>
import React from <span class="token string">'react'</span><span class="token comment" spellcheck="true">;</span>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> App<span class="token punctuation">;</span>
`},preview:function(){var w=p(0),H=p(54),o=p(26),s=p(11),n=e(p(0));function e(h){return h&&h.__esModule?h:{default:h}}var d=s.Layout.Header,f=s.Layout.Content,b=s.Layout.Footer,x=s.Layout.Sider,m=function(){return n.default.createElement(s.Layout,null,n.default.createElement(x,{breakpoint:"lg",collapsedWidth:"0",onBreakpoint:function(g){console.log(g)},onCollapse:function(g,L){console.log(g,L)}},n.default.createElement("div",{className:"logo"}),n.default.createElement(s.Menu,{theme:"dark",mode:"inline",defaultSelectedKeys:["4"],items:[o.UserOutlined,o.VideoCameraOutlined,o.UploadOutlined,o.UserOutlined].map(function(i,g){return{key:String(g+1),icon:n.default.createElement(i),label:"nav ".concat(g+1)}})})),n.default.createElement(s.Layout,null,n.default.createElement(d,{className:"site-layout-sub-header-background",style:{padding:0}}),n.default.createElement(f,{style:{margin:"24px 16px 0"}},n.default.createElement("div",{className:"site-layout-background",style:{padding:24,minHeight:360}},"content")),n.default.createElement(b,{style:{textAlign:"center"}},"Infra Design \xA92018 Created by Ant UED")))},y=m;return w.createElement(y)},style:`#components-layout-demo-responsive .logo {
  height: 32px;
  margin: 16px;
  background: rgba(255, 255, 255, 0.2);
}
...
<span class="token keyword">export</span> <span class="token keyword">default</span> App<span class="token punctuation">;</span>
`},preview:function(){var w=p(0),H=p(54);function o(a){return o=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(l){return typeof l}:function(l){return l&&typeof Symbol=="function"&&l.constructor===Symbol&&l!==Symbol.prototype?"symbol":typeof l},o(a)}var s=p(26),n=p(11),e=f(p(0));function d(a){if(typeof WeakMap!="function")return null;var l=new WeakMap,k=new WeakMap;return(d=function(C){return C?k:l})(a)}function f(a,l){if(!l&&a&&a.__esModule)return a;if(a===null||o(a)!=="object"&&typeof a!="function")return{default:a};var k=d(l);if(k&&k.has(a))return k.get(a);var r={},C=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var S in a)if(S!=="default"&&Object.prototype.hasOwnProperty.call(a,S)){var E=C?Object.getOwnPropertyDescriptor(a,S):null;E&&(E.get||E.set)?Object.defineProperty(r,S,E):r[S]=a[S]}return r.default=a,k&&k.set(a,r),r}function b(a,l){return i(a)||h(a,l)||m(a,l)||x()}function x(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function m(a,l){if(!!a){if(typeof a=="string")return y(a,l);var k=Object.prototype.toString.call(a).slice(8,-1);if(k==="Object"&&a.constructor&&(k=a.constructor.name),k==="Map"||k==="Set")return Array.from(a);if(k==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(k))return y(a,l)}}function y(a,l){(l==null||l>a.length)&&(l=a.length);for(var k=0,r=new Array(l);k<l;k++)r[k]=a[k];return r}function h(a,l){var k=a==null?null:typeof Symbol!="undefined"&&a[Symbol.iterator]||a["@@iterator"];if(k!=null){var r=[],C=!0,S=!1,E,U;try{for(k=k.call(a);!(C=(E=k.next()).done)&&(r.push(E.value),!(l&&r.length===l));C=!0);}catch(M){S=!0,U=M}finally{try{!C&&k.return!=null&&k.return()}finally{if(S)throw U}}return r}}function i(a){if(Array.isArray(a))return a}var g=n.Layout.Header,L=n.Layout.Content,I=n.Layout.Footer,B=n.Layout.Sider;function O(a,l,k,r){return{key:l,icon:k,children:r,label:a}}var u=[O("Option 1","1",e.default.createElement(s.PieChartOutlined,null)),O("Option 2","2",e.default.createElement(s.DesktopOutlined,null)),O("User","sub1",e.default.createElement(s.UserOutlined,null),[O("Tom","3"),O("Bill","4"),O("Alex","5")]),O("Team","sub2",e.default.createElement(s.TeamOutlined,null),[O("Team 1","6"),O("Team 2","8")]),O("Files","9",e.default.createElement(s.FileOutlined,null))],t=function(){var l=(0,e.useState)(!1),k=b(l,2),r=k[0],C=k[1];return e.default.createElement(n.Layout,{style:{minHeight:"100vh"}},e.default.createElement(B,{collapsible:!0,collapsed:r,onCollapse:function(E){return C(E)}},e.default.createElement("div",{className:"logo"}),e.default.createElement(n.Menu,{theme:"dark",defaultSelectedKeys:["1"],mode:"inline",items:u})),e.default.createElement(n.Layout,{className:"site-layout"},e.default.createElement(g,{className:"site-layout-background",style:{padding:0}}),e.default.createElement(L,{style:{margin:"0 16px"}},e.default.createElement(n.Breadcrumb,{style:{margin:"16px 0"}},e.default.createElement(n.Breadcrumb.Item,null,"User"),e.default.createElement(n.Breadcrumb.Item,null,"Bill")),e.default.createElement("div",{className:"site-layout-background",style:{padding:24,minHeight:360}},"Bill is a cat.")),e.default.createElement(I,{style:{textAlign:"center"}},"Ant Design \xA92018 Created by Ant UED")))},c=t;return w.createElement(c)},style:`#components-layout-demo-side .logo {
  height: 32px;
  margin: 16px;
  background: rgba(255, 255, 255, 0.3);
}
