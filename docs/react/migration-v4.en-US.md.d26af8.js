...
<span class="token inserted">+ import { SmileOutlined } from 'infra-design-icons';</span>
...
<span class="token inserted">+       &lt;SmileOutlined /></span>
  ...
  // or directly import
  import SmileOutlined from 'infra-design-icons/SmileOutlined';`},["code",`  import { Button } from 'antd';
...
+       <SmileOutlined />
  ...
  // or directly import
  import SmileOutlined from 'infra-design-icons/SmileOutlined';`]],["p","You will still be able to continue using the compatibility pack:"],["pre",{lang:"jsx",highlighted:`<span class="token keyword">import</span> <span class="token punctuation">{</span> Button <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'antd'</span><span class="token punctuation">;</span>
...
+       icon={<QuestionOutlined />}
    ...
    mountNode,
  );`]],["h4","Replace v3 Icon with ",["code","infra-design-icons"]],["pre",{lang:"diff",highlighted:`<span class="token deleted">- import { Icon, Input } from 'antd';</span>
<span class="token inserted">+ import { Input } from 'antd';</span>
<span class="token inserted">+ import Icon, { CodeFilled, SmileOutlined, SmileTwoTone } from 'infra-design-icons';</span>
...
+   </ConfigProvider>
    mountNode,
  );`]],["h4","Replace ",["code","Modal.method()"]," icon string with ",["code","infra-design-icons"]],["pre",{lang:"diff",highlighted:`  import { Modal } from 'antd';
<span class="token inserted">+ import { AntDesignOutlined } from 'infra-design-icons';</span>
