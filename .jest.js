const transformIgnorePatterns = [
  ...
  '/node_modules/(?!array-move|react-dnd|react-dnd-html5-backend|@react-dnd|dnd-core|tween-one|@babel|@ant-design|infra-design)[^/]+?/(?!(es)/)',
];
...
module.exports = {
  ...
  transform: {
    ...
    '\\.(m?)js$': './node_modules/@infra-fe/tools/lib/jest/codePreprocessor',
